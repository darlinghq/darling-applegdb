...
/* Define to 1 if the system has the type `x86_debug_state32_t'. */
#define HAVE_X86_DEBUG_STATE32_T 1

/* Define to 1 if the system has the type `thread_identifier_info_data_t'. */
#define HAVE_THREAD_IDENTIFIER_INFO_DATA_T 1

/* Define to 1 if the system has the function pthread_setname_np () */
